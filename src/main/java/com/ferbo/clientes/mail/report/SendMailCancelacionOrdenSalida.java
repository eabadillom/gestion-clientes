...
public class SendMailCancelacionOrdenSalida extends Thread 
{
    ...
    public void exec() 
    {
        try{
            ...
            List<Integer> listPlantas = new ArrayList();
    ...
    private void processCancelacion(String folio, Integer idPlanta) 
    {
        ...
        log.info(String.format("Iniciando envío de correo para la cancelación de la orden de salida %s, idPlanta %d", folio, idPlanta));
        ...
        try {
            ...
            {
                log.info("Contacto: " + cteContacto.getContacto().getNombre() + " " + cteContacto.getContacto().getPrimerApellido());
